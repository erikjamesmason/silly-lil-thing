...
@asset(group_name="pokemon", compute_kind="Response")
...
def pokemon_df(context: AssetExecutionContext, pokemon: requests.Response) -> pd.DataFrame:
    """ """
...
@asset(group_name="pokemon", compute_kind="Pandas")
def pokemon_types_df(context: AssetExecutionContext, pokemon_types:requests.Response) -> pd.DataFrame:
    """ """
